...
Third-party components deployed by this project (Apache Kafka, Apache Flink, Apache Druid,
Apache Superset, OpenTelemetry, Grafana, Prometheus, PostgreSQL, MinIO, k3s) are licensed under

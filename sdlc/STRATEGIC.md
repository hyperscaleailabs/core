...
Cadence: **1 / 3 / 6-12 months**. The strategic level owns the **axis** - the
standing answer to why (mission), what (direction and horizons), and how (method
and stack) - and keeps it aligned with what the lower levels actually learn.
